...
#pivot option menu edit...	
	def Pivot_Menu_Edit(self,requester,widget,action):
		...
		r_space = tde4.getWidgetValue(self.req,"r_space")			
		if s_type == 1:
			tde4.modifyOptionMenuWidget(self.req,"t_space","Pivot Space","Global","Local/Screen","Lineup - non functional WIP")
			tde4.modifyOptionMenuWidget(self.req,"r_space","Pivot Space","Global","Local/Screen","Around 3DPoints","Lineup - non functional WIP")	
			tde4.setWidgetValue(self.req,"sel",str(tde4.getCameraName(tde4.getCurrentCamera())))
		...
		if s_type == 2:
			tde4.modifyOptionMenuWidget(self.req,"t_space","Pivot Space","Global","Local","Screen","Lineup - non functional WIP")
			tde4.modifyOptionMenuWidget(self.req,"r_space","Pivot Space","Global","Local","Screen","Lineup - non functional WIP")
			tde4.setWidgetValue(self.req,"sel",str(tde4.getPGroupName(tde4.getCurrentPGroup())))	
...
#build GUI....
	def GUI(self):
		self.window_title = "Patcha Nudge3D Tool v1.0b2.93"
...
#translation pivot widgets...
		tde4.addOptionMenuWidget(self.req,"t_space","Pivot Space","Global","Local/Screen","Lineup - non functional WIP")
...
#rotation pivot widgets...
		tde4.addOptionMenuWidget(self.req,"r_space","Pivot Space","Global","Local/Screen","Around 3DPoints","Lineup - non functional WIP")
