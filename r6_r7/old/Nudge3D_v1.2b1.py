...
#pivot option menu edit...	
	def Pivot_Menu_Edit(self,requester,widget,action):
		...
		if s_type == 4:
			...
			tde4.modifyOptionMenuWidget(self.req,"r_space","Pivot Space","Global","Local","Aroud 3DPoint - Global","Aroud 3DPoint - Local")
...
#build GUI....
	def GUI(self):
		self.window_title = "Patcha Nudge3D Tool v1.2b1"
