...
#pivot option menu edit...	
	def Pivot_Menu_Edit(self,requester,widget,action):
		...
		if s_type == 1:
			...
			tde4.modifyOptionMenuWidget(self.req,"r_space","Pivot Space","Global","Local/Screen","Around 3DPoints - Global","Around 3DPoints - Local")	
		...
		if s_type == 4:
			if pg != None:
				...
				if len(pl) > 0:
					...
					#camera global or local or around 3dpoint rotation nudge...
					if r_space == 1 or r_space == 2:
						if widget == "rot_x+" or widget == "rot_x-" or widget == "rot_y+" or widget == "rot_y-" or widget == "rot_z+" or widget == "rot_z-":
							...
							for pgroup in pgl:
								...
								if pg_type == "OBJECT":
									tde4.setPGroupScale3D(pgroup,tde4.getPGroupScale3D(pgroup))	
					#scale around pivot or around camera...	
					v = tde4.getWidgetValue(self.req,"scale_around_pivot")
					if v == 0:					
						pivot = vec3d(tde4.getPGroupPosition3D(pg,cam,frame))
					else:
...
#build GUI....
	def GUI(self):
		self.window_title = "Patcha Nudge3D Tool v1.1b5"
...
#rotation pivot widgets...
		tde4.addOptionMenuWidget(self.req,"r_space","Pivot Space","Global","Local/Screen","Around 3DPoints - Global","Around 3DPoints - Local")
