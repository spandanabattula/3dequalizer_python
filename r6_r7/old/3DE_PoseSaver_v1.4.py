...
window_title = "Patcha Pose Saver/Loader v1.4"
...
tde4.addTextFieldWidget(req,"from","Import Frame from",str(frame+offset))
...
tde4.addTextFieldWidget(req,"to","Import Frame to",str(frame+offset))
...
tde4.postCustomRequesterAndContinue(req,window_title,500,190)	
