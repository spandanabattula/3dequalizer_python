...
#pivot option menu edit...	
	def Pivot_Menu_Edit(self,requester,widget,action):
		...
		if s_type == 2:
			tde4.modifyOptionMenuWidget(self.req,"t_space","Pivot Space","Global","Local","Screen")
			tde4.modifyOptionMenuWidget(self.req,"r_space","Pivot Space","Global","Local","Screen","Around 3DPoint - Global","Aroud 3DPoint - Local")
			tde4.setWidgetValue(self.req,"sel",str(tde4.getPGroupName(tde4.getCurrentPGroup())))	
		...
		if s_type == 4:
			...
			tde4.modifyOptionMenuWidget(self.req,"r_space","Pivot Space","Global","Aroud 3DPoint - Global","Aroud 3DPoint - Local")
...
#build GUI....
	def GUI(self):
		self.window_title = "Patcha Nudge3D Tool v1.1b9"
