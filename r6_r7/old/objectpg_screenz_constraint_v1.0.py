		...
		if pg_type == "OBJECT":
			if v == 1:
				...
				if len(pl) > 0:
					...
					com = vec3d(tde4.getPGroupPosition3D(current_pg,cam,int(tde4.getCurrentFrame(cam))))
...
window_title = "Patcha ObjectPG Screen Z Constraint v1.0"
...
tde4.setWidgetOffsets(req,"main_button",3,50,70,0)

#delete pivot locator button widget...
tde4.addButtonWidget(req,"delete_pivot_locator_btn","Delete Pivot Locator",70,10)
tde4.setWidgetAttachModes(req,"delete_pivot_locator_btn","ATTACH_POSITION","ATTACH_POSITION","ATTACH_WINDOW","ATTACH_AS_IS")
tde4.setWidgetOffsets(req,"delete_pivot_locator_btn",55,97,70,0)
...
#slider widget...
tde4.addScaleWidget(req,"slider_wdgt","","DOUBLE",0.001,0.1,0.05)
tde4.setWidgetAttachModes(req,"slider_wdgt","ATTACH_POSITION","ATTACH_POSITION","ATTACH_WINDOW","ATTACH_AS_IS")
tde4.setWidgetOffsets(req,"slider_wdgt",5,95,100,0)
...
tde4.setWidgetOffsets(req,"screenz-",15,45,130,0)

#screen Z+ button widget...
tde4.addButtonWidget(req,"screenz+","Screen Z +",70,10)
tde4.setWidgetAttachModes(req,"screenz+","ATTACH_POSITION","ATTACH_POSITION","ATTACH_WINDOW","ATTACH_AS_IS")
tde4.setWidgetOffsets(req,"screenz+",55,85,130,0)
...
tde4.postCustomRequesterAndContinue(req,window_title,450,160)
