...
window_title = "Patcha ObjectPG Screen Z Constraint v1.1"
...
tde4.addButtonWidget(req,"screenx+","Screen X +",70,10)
...
tde4.addButtonWidget(req,"screeny+","Screen Y +",70,10)
...
tde4.postCustomRequesterAndContinue(req,window_title,480,190)
