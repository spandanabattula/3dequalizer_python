...
window_title = "Patcha Pose Saver/Loader v1.4.5"
...
def Store_Old_Pose():
	...
	if pg_type == "OBJECT":
		pos = tde4.getPGroupPosition3D(pg,cam,frame)
		rot = tde4.getPGroupRotation3D(pg,cam,frame)
		newvalues = tde4.convertObjectPGroupTransformationWorldTo3DE(cam, frame, rot, pos, 1.0, 0)
		l.append(newvalues)		
	return l
...
tde4.addButtonWidget(req,"revert","Revert curve editor",70,10)
