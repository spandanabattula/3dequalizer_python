...
def Create_Keys(req,widget,action):
	...
	pos_x_offset_curve_y = tde4.evaluateCurve(pos_x_offset_curve,frame)		
	key = tde4.createCurveKey(pos_x_offset_curve,[frame,pos_x_offset_curve_y])
	tde4.setCurveKeyFixedXFlag(pos_x_offset_curve,key,1)
	tde4.setCurveKeyMode(pos_x_offset_curve,key,"LINEAR")
	pos_y_offset_curve_y = tde4.evaluateCurve(pos_y_offset_curve,frame)
	key = tde4.createCurveKey(pos_y_offset_curve,[frame,pos_y_offset_curve_y])
	tde4.setCurveKeyFixedXFlag(pos_y_offset_curve,key,1)
	tde4.setCurveKeyMode(pos_y_offset_curve,key,"LINEAR")
	pos_z_offset_curve_y = tde4.evaluateCurve(pos_z_offset_curve,frame)
	key = tde4.createCurveKey(pos_z_offset_curve,[frame,pos_z_offset_curve_y])
	tde4.setCurveKeyFixedXFlag(pos_z_offset_curve,key,1)
	tde4.setCurveKeyMode(pos_z_offset_curve,key,"LINEAR")
	rot_x_offset_curve_y = tde4.evaluateCurve(rot_x_offset_curve,frame)
	key = tde4.createCurveKey(rot_x_offset_curve,[frame,rot_x_offset_curve_y])
	tde4.setCurveKeyFixedXFlag(rot_x_offset_curve,key,1)
	tde4.setCurveKeyMode(rot_x_offset_curve,key,"LINEAR")
	rot_y_offset_curve_y = tde4.evaluateCurve(rot_y_offset_curve,frame)
	key = tde4.createCurveKey(rot_y_offset_curve,[frame,rot_y_offset_curve_y])
	tde4.setCurveKeyFixedXFlag(rot_y_offset_curve,key,1)
	tde4.setCurveKeyMode(rot_y_offset_curve,key,"LINEAR")
	rot_z_offset_curve_y = tde4.evaluateCurve(rot_z_offset_curve,frame)
	key = tde4.createCurveKey(rot_z_offset_curve,[frame,rot_z_offset_curve_y])
	tde4.setCurveKeyFixedXFlag(rot_z_offset_curve,key,1)
	tde4.setCurveKeyMode(rot_z_offset_curve,key,"LINEAR")
...
def Main_Callback(req,widget,action):
	...
	if widget == "update_offset_curves_btn":
		...
		tde4.filterPGroup(pg,cam)
		tde4.setPGroupPostfilterMode(pg,pf_mode)
	if widget == "bake_offset_curves_btn":
		for frame in range(1,frames+1):		
			new_pos_x = Merge_Curves(pos_x_curve,pos_x_offset_curve,frame)
			new_pos_y = Merge_Curves(pos_y_curve,pos_y_offset_curve,frame)
			new_pos_z = Merge_Curves(pos_z_curve,pos_z_offset_curve,frame)
...
window_title = "Patcha Camera/Object offset Curve Editor v1.0"
...
tde4.setWidgetOffsets(req,"menu_bar",2,30,2,0)
""""#add file menu...
...
tde4.addTextFieldWidget(req,"pg_name_txt","","")
...
tde4.setWidgetOffsets(req,"pg_name_txt",32,70,2,0)
...
tde4.insertListWidgetItem(req,"curves_list","offset Position X",6)
tde4.insertListWidgetItem(req,"curves_list","offset Position Y",7)
tde4.insertListWidgetItem(req,"curves_list","offset Position Z",8)
tde4.insertListWidgetItem(req,"curves_list","offset Rotation X",9)
tde4.insertListWidgetItem(req,"curves_list","offset Rotation Y",10)
tde4.insertListWidgetItem(req,"curves_list","offset Rotation Z",11)

#update offset curves button widget...
tde4.addButtonWidget(req,"update_offset_curves_btn","Update Offset Curves",150,5)
tde4.setWidgetLinks(req,"update_offset_curves_btn","","","curves_area","")

#bake offset curves button widget...
tde4.addButtonWidget(req,"bake_offset_curves_btn","Bake Offset Curves",140,5)
...
tde4.addButtonWidget(req,"create_keys_btn","Create Offset Keys",140,5)
tde4.setWidgetLinks(req,"create_keys_btn","bake_offset_curves_btn","","curves_area","")
tde4.setWidgetOffsets(req,"create_keys_btn",326,0,5,0)

#delete all offset curves keys button widget...
tde4.addButtonWidget(req,"delete_keys_btn","Delete All Offset Keys",150,5)
...
tde4.addButtonWidget(req,"key-","Key -",75,5)
tde4.setWidgetLinks(req,"key-","bake_offset_curves_btn","","curves_area","")
tde4.setWidgetOffsets(req,"key-",660,0,5,0)

#add key+ button widget...
tde4.addButtonWidget(req,"key+","Key +",75,5)
tde4.setWidgetLinks(req,"key+","key-","","curves_area","")
tde4.setWidgetOffsets(req,"key+",745,0,5,0)

#add view all button...
tde4.addButtonWidget(req,"view_all","View All",70,5)
tde4.setWidgetLinks(req,"view_all","key+","","curves_area","")
tde4.setWidgetOffsets(req,"view_all",835,0,5,0)
...
tde4.setWidgetCallbackFunction(req,"bake_offset_curves_btn","Main_Callback")
...
tde4.setWidgetCallbackFunction(req,"key+","Main_Callback")
tde4.setWidgetCallbackFunction(req,"delete_keys_btn","Main_Callback")
