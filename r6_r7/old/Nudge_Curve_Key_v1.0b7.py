...
#build GUI...			
	def GUI(self):
		self.window_title = "Patcha Nudge Curve Key v1.0b7"
...
#jump previous key...
			tde4.addButtonWidget(self.req,"previouskey","Jump previous key",70,10)
			tde4.setWidgetAttachModes(self.req,"previouskey","ATTACH_POSITION","ATTACH_POSITION","ATTACH_WINDOW","ATTACH_AS_IS")
			tde4.setWidgetOffsets(self.req,"previouskey",5,35,190,0)	
#jump pickup key...
			...
			tde4.setWidgetOffsets(self.req,"pickup",37,65,190,0)	
#jump next key...
			tde4.addButtonWidget(self.req,"nextkey","Jump next key",70,10)
			tde4.setWidgetAttachModes(self.req,"nextkey","ATTACH_POSITION","ATTACH_POSITION","ATTACH_WINDOW","ATTACH_AS_IS")
			tde4.setWidgetOffsets(self.req,"nextkey",67,95,190,0)														
#widgetcallbacks...
