...
#GUI...
window_title = "Patcha Bake objectPG motionpath pivot to new point v1.1"
...
tde4.addButtonWidget(req,"move_path_btn","Bake objectPG motionpath pivot to point",70,10)
