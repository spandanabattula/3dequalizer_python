...
#pivot option menu edit...	
	def Pivot_Menu_Edit(self,requester,widget,action):
		...
		if s_type == 4:
			...
			tde4.modifyOptionMenuWidget(self.req,"r_space","Pivot Space","Global","Aroud 3DPoints - Global","Aroud 3DPoints - Local")
...
#build GUI....
	def GUI(self):
		self.window_title = "Patcha Nudge3D Tool v1.1b8"
...
#focal nudget callback...
		...
		tde4.postCustomRequesterAndContinue(self.req,self.window_title,420,730,"do.update")
