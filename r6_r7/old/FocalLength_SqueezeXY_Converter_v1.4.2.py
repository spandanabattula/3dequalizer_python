...
def Focal_to_SqXY(req,widget,action):
	pg = tde4.getCurrentPGroup()
	cam = tde4.getCurrentCamera()
	frames = tde4.getCameraNoFrames(cam)
	if cam!=None:
...
#build GUI...
window_title = "Patcha Focal-SqueezeX/Y Converter v1.4.2"
...
tde4.setWidgetCallbackFunction(req,"focal_to_sqxy","Focal_to_SqXY")
