...
if pg!=None and cam !=None and tde4.getPGroupType(pg)=="CAMERA" or tde4.getCameraType(cam) =="REF_FRAME":
		...
		if path!=None:
			...
			if not f.closed:
				...
				if len(a) == 6:
					...
					tde4.postQuestionRequester("3DE Import Pose......","there must be exactly 6 values in a row","ok")
else:
	tde4.postQuestionRequester("Error...", "there must be a cameragroup and point group.", "ok")			
