...
window_title = "Patcha 3D cones v1.2.4"
def create_cone():
...
tde4.setWidgetOffsets(req,"prop_scale_button",10,40,160,0)
tde4.setWidgetSensitiveFlag(req,"prop_scale_button",0)
...
tde4.setWidgetOffsets(req,"toggle_lines",60,64,160,0)
...
tde4.setWidgetOffsets(req,"toggle_polygons",85,89,160,0)
#callback
...
tde4.postCustomRequesterAndContinue(req,window_title,635,270)
