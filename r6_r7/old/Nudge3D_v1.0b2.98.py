...
#build GUI....
	def GUI(self):
		self.window_title = "Patcha Nudge3D Tool v1.0b2.98"
...
#average 3dpoint callback...
		...
		tde4.postCustomRequesterAndContinue(self.req,self.window_title,360,575,"do.update")
