...
#
# 3DE4.script.comment: Takes animated anamorphic SqY, sets it to a static value of 1 and then bakes animated focal and SqX to compensate.
#
# Patcha Saheb(patchasaheb@gmail.com) / Michael Karp (mckarp@aol.com)

#pseudo code...

#Take reciprocal of raw SqY
#Multiply reciprocal of raw SqY  * (raw SqX)
#Multiply reciprocal of raw SqY  * (raw SqY) [sets to 1]
#Multiply reciprocal of baked SqY  * (Focal)
...
#multiply reciprocal of sqeeze y with sqx and focal...
	for j in range(0,len(sq_y_list)):
		new_sq_x = sq_y_list[j] * sq_x_list[j]
		new_focal = sq_y_list[j] * focal_list[j]
