...
#update function...		
	def update(self,requester):
		...
		if s_type == 1 and r_space == 3 or s_type == 2 and r_space == 4:
...
#build GUI....
	def GUI(self):
		self.window_title = "Patcha Nudge3D Tool v1.0b2.96"
		self.req = tde4.createCustomRequester()
#type widget...
		tde4.addOptionMenuWidget(self.req,"selected_menu","Selected Type","Camera","Object PGroup","3D Model","Motion Trail")
#sep1 widget...
