...
window_title = "Patcha Pose Saver/Loader v1.3"
...
try:
	...
	tde4.addTextFieldWidget(req,"from","Frame from"," ")
...
ret = tde4.postCustomRequesterAndContinue(req,window_title,500,190)	
