...
#pivot option menu edit...	
	def Pivot_Menu_Edit(self,requester,widget,action):
		...
		if s_type == 4:
			...
			tde4.modifyOptionMenuWidget(self.req,"r_space","Pivot Space","Global","Aroud 3DPoints")
			tde4.setWidgetValue(self.req,"sel"," ")
			tde4.setWidgetValue(self.req,"look"," ")
		if s_type == 4 and r_space == 1:
						...
						if widget == "rot_x+" or widget == "rot_x-":
							...
							for point in pl:
								if tde4.isPointCalculated3D(pg,point):								
									...
									ry *= math.pi / 180.0
									rz *= math.pi / 180.0
									p3d = rot3d(rx,ry,rz,VL_APPLY_ZXY) * (p3d - pivot) + pivot
									tde4.setPointSurveyPosition3D(pg,point,p3d.list())
						if widget == "rot_y+" or widget == "rot_y-":
							if widget == "rot_y-": r_power = -float(r_power)
							if r_space == 1:
...
#build GUI....
	def GUI(self):
		self.window_title = "Patcha Nudge3D Tool v1.1b2"
...
#pick frame out button widget...
		...
		tde4.setWidgetOffsets(self.req,"toggle",38,44,640,0)
...
#pick frame out callback...
		...
		tde4.postCustomRequesterAndContinue(self.req,self.window_title,410,670,"do.update")
