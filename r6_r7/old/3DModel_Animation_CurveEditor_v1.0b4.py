...
window_title = "Patcha 3DModel Animation Curve Editor v1.0b4"
	...
	if len(mlist) > 0:
		...
		if count == 0:
			try:
				...
				tde4.setWidgetAttachModes(anim_req,"model_list","ATTACH_POSITION","ATTACH_POSITION","ATTACH_WINDOW","ATTACH_WINDOW")
				tde4.setWidgetOffsets(anim_req,"model_list",83,99,25,470)
